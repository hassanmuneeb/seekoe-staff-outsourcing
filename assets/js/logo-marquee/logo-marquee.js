    ...
    function setWidth() {
        Array.prototype.forEach.call(g_marquee, (parentItem) => {
            ...
            if (direction == "up" || direction == "down") {
                if (isBreakPoint(767)) parentItem.style.height = (dataHeight + dataMargin) * dataItemsNumberMobile + "px";

                if (isBreakPoint(1024)) parentItem.style.height = (dataHeight + dataMargin) * dataItemsNumberTablet + "px";
            ...
            Array.prototype.forEach.call(slide, (item) => {
                if (direction == "right" || direction == "left") item.style.marginRight = dataMargin + "px";

                if (direction == "up" || direction == "down") item.style.marginTop = dataMargin + "px";

                if (direction == "right" || direction == "left") {
                    if (isBreakPoint(767)) item.style.width = parentWidth / dataItemsNumberMobile - dataMargin + "px";

                    if (isBreakPoint(1024)) item.style.width = parentWidth / dataItemsNumberTablet - dataMargin + "px";
